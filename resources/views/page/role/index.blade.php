        ...
        <div class="lg:w-10/12 w-full max-h-screen overflow-auto" :class="{ 'lg:w-10/12': sidebar, 'lg:w-full': !sidebar }">
            ...
            <div class="mt-8 px-6 py-4 mx-4 bg-white rounded-lg shadow-xl">
                <div class="w-full flex items-center justify-between mb-4">
                    <h2 class="text-lg font-semibold mb-4">Daftar Roles</h2>
                    <div>
                        <a href="{{ route('roles.create') }}" class="p-2 rounded-lg shadow-lg text-white hover:scale-105 duration-150 bg-[#125D72]">+ <span class="hidden md:inline">New</span></a>
                    </div>
                </div>
