        ...
        <div class="lg:w-10/12 w-full max-h-screen overflow-auto" :class="{ 'lg:w-10/12': sidebar, 'lg:w-full': !sidebar }">
            ...
            <div class="max-w-xl mx-auto p-6">
                <div class="flex items-center gap-2 mb-6 mx-4">
                    <a href="{{ route('roles') }}" class="text-gray-500 text-4xl cursor-pointer font-bold flex items-center hover:scale-105"><</a>
                    <div class="text-2xl font-semibold flex items-center">Tambah Role</div>
                </div>
                ...
                <div class="bg-white shadow rounded-lg p-6">
                    <form method="POST" action="">
                        ...
                        <!-- Nama Role -->
                        <div class="mb-4">
                            <label for="current_password" class="block text-sm font-medium text-gray-700">Nama Role</label>
